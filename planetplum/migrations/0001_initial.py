    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associates', models.ManyToManyField(blank=True, related_name='associated', to=settings.AUTH_USER_MODEL)),
                ('members', models.ManyToManyField(blank=True, related_name='bands', to=settings.AUTH_USER_MODEL)),
